    ...
    <div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-5">
        <div className="space-y-6 lg:col-span-3">
          ...
          <Card title="Recent transactions" right={<a className="text-xs text-attest hover:underline" href="/app/transactions">all →</a>}>
          ...
          <Card title="Live rails">
            <ul className="space-y-3 text-sm">
              <li className="flex justify-between gap-2">
                ...
                <span className="font-mono text-ok">x402 · veil-exact</span>
              </li>
              <li className="flex justify-between gap-2">
                <span className="text-mut">Settlement</span>
                <span className="font-mono text-cyan-300">SettlementEngine (mirror)</span>
              </li>
              <li className="flex justify-between gap-2">
                <span className="text-mut">Attestation</span>
                <span className="font-mono text-attest">mirrored · no live ASC</span>
              </li>
              <li className="flex justify-between gap-2">
                <span className="text-mut">Audit at rest</span>
                <span className="font-mono text-attest">AES-256-GCM sealed</span>
              </li>
              <li className="flex justify-between gap-2">
            ...
            <p className="mt-4 border-t border-line pt-4 text-xs leading-relaxed text-mut">
